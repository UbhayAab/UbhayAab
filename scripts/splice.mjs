...
<br>${S.partialVisibility ? `
<b>This run could not see ${S.partialVisibility.missingCount} private repositories</b>, so their numbers are carried
forward from ${stamp(S.partialVisibility.lastFullRun)} rather than dropped.
<br>` : ''}
